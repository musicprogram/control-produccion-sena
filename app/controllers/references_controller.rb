class ReferencesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @reference.save
        format.html { redirect_to new_reference_fichatecnica_path(@reference), notice: 'Reference was successfully created.' }
  ...
  private
    ...
    def reference_params
      params.require(:reference).permit(:ref, :nombre, :descripcion)
    end
end
