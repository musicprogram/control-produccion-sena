class BalancesController < ApplicationController
  ...
  # GET /balances/1.json
  def show
    @resultbalances = Resultbalance.where(balance_id: @balance.id)
  end
  ...
  private
    ...
    def balance_params
      params.require(:balance).permit(:reference_id, :pedido_prendas, :jornada_laboral, :talk_time, :tiempo_total)
    end
end
