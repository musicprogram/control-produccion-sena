...
class MaquinasControllerTest < ActionController::TestCase
  ...
  test "should create maquina" do
    assert_difference('Maquina.count') do
      post :create, maquina: { especificaciones: @maquina.especificaciones, estadom_id: @maquina.estadom_id, nombre: @maquina.nombre }
    end
  ...
  test "should update maquina" do
    patch :update, id: @maquina, maquina: { especificaciones: @maquina.especificaciones, estadom_id: @maquina.estadom_id, nombre: @maquina.nombre }
    assert_redirected_to maquina_path(assigns(:maquina))
  end
