...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { apellidos: @instructor.apellidos, documento_id: @instructor.documento_id, email: @instructor.email, modulo_id: @instructor.modulo_id, nombre: @instructor.nombre, numdocumento: @instructor.numdocumento }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { apellidos: @instructor.apellidos, documento_id: @instructor.documento_id, email: @instructor.email, modulo_id: @instructor.modulo_id, nombre: @instructor.nombre, numdocumento: @instructor.numdocumento }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
