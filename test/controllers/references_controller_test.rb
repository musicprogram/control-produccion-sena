...
class ReferencesControllerTest < ActionController::TestCase
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post :create, reference: { descripcion: @reference.descripcion, nombre: @reference.nombre, ref: @reference.ref }
    end
  ...
  test "should update reference" do
    patch :update, id: @reference, reference: { descripcion: @reference.descripcion, nombre: @reference.nombre, ref: @reference.ref }
    assert_redirected_to reference_path(assigns(:reference))
  end
